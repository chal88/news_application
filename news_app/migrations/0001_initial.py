            ...
            fields=[
                ...
                ('username', models.CharField(
                    error_messages={
                        'unique': 
                        'A user with that '
                        'username already exists.'}, help_text='Required. 150'
                ...
                ('is_active', models.BooleanField(
                    default=True, help_text='Designates whether this user'
                    'should be treated as active. Unselect this instead of'
                    'deleting accounts.', verbose_name='active')),
                ('date_joined', models.DateTimeField(
                    default=django.utils.timezone.now,
                    verbose_name='date joined')),
                ('role', models.CharField(choices=[('reader', 'Reader'),
                                                   ('editor', 'Editor'),
                ...
                ('subscribed_journalists', models.ManyToManyField(
                    blank=True, related_name='journalist_subscribers',
                    to=settings.AUTH_USER_MODEL)),
                ('user_permissions', models.ManyToManyField(
                    blank=True, help_text='Specific permissions' \
                    'for this user.', related_name='user_set',
                ...
                ('subscribed_publishers', models.ManyToManyField(
                    blank=True, related_name='subscribers',
                    to='news_app.publisher')),
            ],
            options={
                'verbose_name': 'user',
